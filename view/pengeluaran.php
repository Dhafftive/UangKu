<?php 
    ...
    require '../function/readkeluar.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>UangKu - Pengeluaran</title>
    <!-- Fonts Google -->
...
<body>
    ...
    <main>
        <div class="left">
            <div class="grafik">
                <iframe src="piekeluar.php" width="100%" height="350" style="outline: none; border: none;"></iframe>
                <div class="tambah-kategori">
                    <p class="add-kategori">Tambah kategori</p>
                    <div class="btn-add">
                        <a href="./addkategoripengeluaran.php"><i class="fa-solid fa-plus"></i></a>
                    </div>
                </div>
            </div>
            <div class="pengeluaran">
                <div class="btn-tambah">
                    <a href="./tambahPengeluaran.php"><i class="fa-solid fa-plus"></i></a>
                </div>
                <div class="text">
                    <p class="saldo-out">Pengeluaran anda</p>
                    <p class="nominal-keluar">Rp. <?php echo $totalPengeluaranFormatted ?></p>
                </div>
            </div>
        </div>
        <div class="right">
            <p class="notice">Ini adalah Aktivitas Pengeluaran Anda</p>
            ...
            <div class="table">
                ...
                <?php      
                    ...
                    $tanggal_terformat = date("d M Y", strtotime($row["tgl_pengeluaran"]));
                ?>
                            <tr class="menu-table">
                                <td><?php echo $row["catatan_keluar"] ?></td>
                                <td><?php echo $row["kategori_keluar"] ?></td>
                                <td>Rp. <?php echo number_format($row["jumlah_keluar"], 0, '.', '.'); ?></td>
                                <td style="text-align: center;"><?php echo $tanggal_terformat ?></td>
            <form id="deleteForm" action="../function/delpengeluaran.php?id_pengeluaran=<?php echo $row["id_pengeluaran"] ?>" method="post">
                                <td style="display: flex; justify-content: center; align-items: center;">
                                    <label for="data1">
                                        <input type="checkbox" class="checkbox" name="data[]" value="<?php echo $row["id_pengeluaran"];?>" data-id="<?php echo $row["id_pengeluaran"];?>"> 
                                    </label>
                                </td>
                                ...
                                document.addEventListener("DOMContentLoaded", function () {
                                    ...
                                    checkboxes.forEach(function (checkbox) {
                                        checkbox.addEventListener("change", function () {
                                            ...
                                            // Mengumpulkan ID pengeluaran yang dicentang
    ...
    <script src="../script/edit-keluar.js"></script>
    <script src="../script/unduhdatakeluar.js"></script>
</body>
</html>